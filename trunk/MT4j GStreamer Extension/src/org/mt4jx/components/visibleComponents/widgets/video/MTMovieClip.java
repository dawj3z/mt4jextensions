...
public class MTMovieClip extends MTRectangle implements IdragClusterable {
	...
	public MTMovieClip(String movieFile, Vertex upperLeft, int ifps, PApplet pApplet) {
		super(pApplet, upperLeft, 100, 100);
		this.app = pApplet;
		this.selected = false;
...
//					playSymbol.setSizeXYRelativeToParent(this.getHeightXY(TransformSpace.LOCAL), this.getHeightXY(TransformSpace.LOCAL));
				...
				slider = new MTSlider(app, lowerLeft.x + sliderXPadding, lowerLeft.y - sliderHeight - sliderYPadding, MTMovieClip.this.getWidthXY(TransformSpace.LOCAL) - sliderXPadding*2, sliderHeight, 0, 10);
				...
				volumeSlider = new MTSlider(app, movieUpperLeft.x + 1.5f, movieUpperLeft.y - volSliderHeight - 1.5f, volSliderWidth, volSliderHeight, 0, 1);
