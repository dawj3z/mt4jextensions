...
public class Microsoft {
  ...
  public static class BirdViewProvider extends MicrosoftProvider {
	  public String[] getTileUrls(Coordinate coordinate) {
		  String url = "http://c" + (int)random(0, 1) + "." + "p" + (int)random(0, 15) + ".oblique.tiles.virtualearth.net/tiles/c" + getZoomString(sourceCoordinate(coordinate)) + ".jpeg?g=90";
		  return new String[] {         url       };
	  }
  }
